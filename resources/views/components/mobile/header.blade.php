...
<header class="sticky top-0 z-40 bg-[#000000] shadow-sm"
    ...
    <div class="flex items-center gap-2 px-3 md:px-6 py-3 md:h-14 max-w-[1250px] mx-auto">
        ...
        <!-- Logo -->
        <a href="{{ route('home') }}"
           class="flex items-center flex-shrink-0 text-[#D4AF37] font-bold text-base md:text-xl tracking-tight hover:brightness-110 transition whitespace-nowrap ml-1">
