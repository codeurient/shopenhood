<x-guest-layout>
    ...
    <!-- Filter Bar -->
    <div class="px-4 py-2 bg-white border-b border-gray-200 flex items-center justify-between gap-2">
        <!-- Active Filters -->
        ...
        <form method="GET" action="{{ route('listings.index') }}" class="flex-shrink-0">
            ...
            <select name="sort"
                    ...
                    class="text-xs border-0 bg-gray-100 rounded-lg py-1.5 px-2 text-gray-700 focus:ring-2 focus:ring-primary-500 cursor-pointer">
