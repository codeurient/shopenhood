<x-app-layout>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <h1 class="text-xl font-bold text-[#1A1A1A]">Add Address</h1>
        </div>
    </div>
            ...
            <div class="bg-white border border-[#E0E0E0] rounded-lg shadow-sm overflow-hidden">
                ...
                <div class="px-5 py-4">
                    <textarea name="additional_notes" rows="3"
                              ...
                              class="w-full px-3 py-2 bg-white border border-[#E0E0E0] rounded text-[13px] text-[#1A1A1A] placeholder-[#37474F]/50 focus:border-[#D4AF37] focus:outline-none transition resize-none">{{ old('additional_notes') }}</textarea>
                </div>
            </div>
