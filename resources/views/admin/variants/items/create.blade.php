...
@section('title', 'Add Item to ' . $variant->name)
@section('page-title', 'Add Variant Item')
...
<div>
    ...
    <div class="flex justify-between items-start mb-6">
        <div>
            <h2 class="text-2xl font-bold text-[#1A1A1A]">Add Item to "{{ $variant->name }}"</h2>
    ...
    <div class="bg-white border border-[#E0E0E0] rounded-[6px] shadow-[0_1px_4px_rgba(0,0,0,0.08)] overflow-hidden">
        <form action="{{ route('admin.variants.items.store', $variant) }}" method="POST" enctype="multipart/form-data" id="itemForm">
            @csrf
                    ...
                    <div class="bg-gray-50 border border-[#E0E0E0] rounded-[6px] p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-[12px] text-[#37474F]">Small icon/swatch (max 1MB, JPEG/PNG/WebP)</p>
                                @error('image')
                                    <p class="mt-1 text-[12px] text-red-600">{{ $message }}</p>
                                @enderror
