                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            <input type="text"
                                   ...
                                   class="w-32 px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500">
                        </td>
                        ...
                        <template x-for="variant in categoryVariants.filter(v => v.is_main_shown)" :key="variant.id">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                <select :name="`variations[${index}][attributes][${variant.id}]`"
                                        ...
                                        class="w-full px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            <input type="number"
                                   ...
                                   placeholder="0.00"
                                   required
                                   class="w-24 px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500">
                        </td>
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            <input type="number"
                                   ...
                                   placeholder="0"
                                   class="w-20 px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500">
                        </td>
