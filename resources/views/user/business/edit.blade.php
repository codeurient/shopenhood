                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="return_policy" id="return_policy" rows="4"
                                      class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('return_policy', $businessProfile->return_policy) }}</textarea>
                            @error('return_policy')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="shipping_policy" id="shipping_policy" rows="4"
                                      class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('shipping_policy', $businessProfile->shipping_policy) }}</textarea>
