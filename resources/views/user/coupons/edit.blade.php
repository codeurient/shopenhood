<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Coupon: {{ $coupon->code }}</h2>
<<<<<<< HEAD
...
<<<<<<< HEAD
                <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 text-blue-700 dark:text-blue-300 rounded-lg">
                    <p class="text-sm">
=======
...
>>>>>>> 126dacd81adcef53b155a6e3204b9d6deaeaba7e
            ...
            <form action="{{ route('user.coupons.update', $coupon) }}" method="POST" x-data="couponForm()">
                @csrf
                @method('PUT')
...
=======
                                  ...
                                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-indigo-500 focus:border-indigo-500">{{ old('description', $coupon->description) }}</textarea>
>>>>>>> 126dacd81adcef53b155a6e3204b9d6deaeaba7e
                    </div>
