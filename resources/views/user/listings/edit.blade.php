                            ...
                            <div class="space-y-4">
                                ...
                                <div x-show="listingType === 'barter'">
                                    ...
                                    <textarea name="barter_exchange_for" rows="3" maxlength="1000"
                                              ...
                                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500">{{ old('barter_exchange_for', $listing->barter_exchange_for) }}</textarea>
                                ...
                                <div x-show="listingType === 'gift'">
                                    <div class="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg">
                                        <p class="text-sm text-green-700 dark:text-green-300">🎁 This item is listed as <strong>free</strong>. Specify any pickup or delivery arrangements below.</p>
                                    </div>
                                </div>
                                        ...
                                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-3">
                                            <label class="flex items-center mb-3">
                                                <input type="checkbox" name="has_same_city_delivery" value="1"
                                                       {{ old('has_same_city_delivery', $listing->has_same_city_delivery) ? 'checked' : '' }}
                                                       class="w-4 h-4 text-primary-600 rounded border-gray-300 dark:border-gray-600 focus:ring-primary-500">
                                            ...
                                            <div class="grid grid-cols-2 gap-3">
                                                <div>
                                                    ...
                                                    <input type="number" name="same_city_delivery_price" step="0.01" min="0"
                                                           value="{{ old('same_city_delivery_price', $listing->same_city_delivery_price) }}" placeholder="0.00"
                                                ...
                                                <div>
                                                    ...
                                                    <input type="number" name="same_city_delivery_days" min="1" max="365"
                                                           value="{{ old('same_city_delivery_days', $listing->same_city_delivery_days) }}" placeholder="e.g. 1"
                                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="grid grid-cols-2 gap-3">
                                                <div>
                                                    ...
                                                    <input type="number" name="domestic_delivery_price" step="0.01" min="0"
                                                           value="{{ old('domestic_delivery_price', $listing->domestic_delivery_price) }}" placeholder="0.00"
                                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm">
                                                </div>
                                                <div>
                                                    <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Days</label>
                                                    <input type="number" name="domestic_delivery_days" min="1" max="365"
                                                           value="{{ old('domestic_delivery_days', $listing->domestic_delivery_days) }}" placeholder="e.g. 3"
                                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="grid grid-cols-2 gap-3">
                                                <div>
                                                    ...
                                                    <input type="number" name="international_delivery_price" step="0.01" min="0"
                                                           value="{{ old('international_delivery_price', $listing->international_delivery_price) }}" placeholder="0.00"
                                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm">
                                                </div>
                                                <div>
                                                    <label class="block text-xs text-gray-500 dark:text-gray-400 mb-1">Days</label>
                                                    <input type="number" name="international_delivery_days" min="1" max="365"
                                                           value="{{ old('international_delivery_days', $listing->international_delivery_days) }}" placeholder="e.g. 14"
                                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-lg focus:ring-primary-500 focus:border-primary-500 text-sm">
                                                </div>
                                            </div>
                                        </div>
