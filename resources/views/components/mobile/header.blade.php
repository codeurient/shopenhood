            ...
            <form action="{{ route('listings.index') }}" method="GET">
                <div class="relative">
                    ...
                    <button type="button"
                            ...
                            class="md:hidden absolute right-3 top-1/2 -translate-y-1/2 text-[#37474F] hover:text-[#D4AF37] transition">
                        <i class="fa-solid fa-filter text-sm"></i>
                    </button>
                    <!-- Search submit button (desktop only) -->
                    <button type="submit"
                            class="hidden md:flex absolute right-3 top-1/2 -translate-y-1/2 items-center justify-center text-[#37474F] hover:text-[#D4AF37] transition">
                        <i class="fa-solid fa-filter text-sm"></i>
                    </button>
