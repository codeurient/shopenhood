...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-3xl font-bold text-gray-900">Edit Slider/Banner</h2>
            <p class="text-gray-600 mt-1">Update slider or banner information</p>
        </div>
                ...
                <div class="pb-6 border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <label class="relative flex cursor-pointer rounded-lg border border-gray-300 bg-white p-4 shadow-sm focus:outline-none hover:border-primary-500 transition">
                            <input type="radio" name="type" value="main_slider" class="sr-only" {{ old('type', $slider->type) === 'main_slider' ? 'checked' : '' }}>
                        ...
                        <label class="relative flex cursor-pointer rounded-lg border border-gray-300 bg-white p-4 shadow-sm focus:outline-none hover:border-primary-500 transition">
                            <input type="radio" name="type" value="banner_small" class="sr-only" {{ old('type', $slider->type) === 'banner_small' ? 'checked' : '' }}>
                            <span class="flex flex-1">
                                <span class="flex flex-col">
                ...
                <div class="pb-6 border-b border-gray-200">
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <img src="{{ asset('storage/' . $slider->image) }}" alt="{{ $slider->title }}" class="max-w-full h-auto rounded-lg border border-gray-300">
                        </div>
